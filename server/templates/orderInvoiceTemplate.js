    ...
    <header>
        ...
        <div class="headerright">
            <div class="headerrightupper">
                <div class="hrucontact">Contact us: 873292540000 || fenil9090vaghasiya.com</div>
                <div class="hruinvoiceid"><b>Product Invoice #</b>${
                  order.iUserId + "" + Date.now()
                }</div>
            </div>
            <div class="headerrightbottom">
                <p><i><span>Eshop.com, </span>Warehouse Address: Philipes St, 42, Stwarbery Rd, NH, USA, 233022</i></p>
            </div>
        </div>
    </header>
    <hr>
...
<footer>
    ...
    <p>
        <i>Regd office: Philipes St, 42, Stwarbery Rd, NH, USA, 233022</i>
    </p>
    <hr>
</footer>
</body>
